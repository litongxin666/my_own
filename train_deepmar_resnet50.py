...
from utils_attr import str2bool
from utils_attr import transfer_optim_state
from utils_attr import time_str
from utils_attr import save_ckpt, load_ckpt
from utils_attr import ReDirectSTD
from utils_attr import adjust_lr_staircase
from utils_attr import set_devices
from utils_attr import AverageMeter
from utils_attr import to_scalar
from utils_attr import may_set_mode
from utils_attr import may_mkdir
from utils_attr import set_seed
...
class Config(object):
    def __init__(self):
        ...
        ## dataset parameter
        parser.add_argument('--dataset_path', type=str, default='/home/litongxin')
...
train_set = Attribute_Dataset(cfg.dataset_path, dataset_name='Market-1501')
num_att = cfg.num_att
...
test_set = Attribute_test(cfg.dataset_path, dataset_name='Market-1501')
model = model.attribute(**cfg.model_kwargs)
...
if cfg.load_model_weight:
    map_location = (lambda storage, loc:storage)  #GPU->CPU
